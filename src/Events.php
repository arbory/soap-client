...
final class Events
{
     ...
     *
     * Listeners of this event are passed a Arbory\Soap\Client\Event\WsdlRequestEvent instance. To implement your
     ...
     *
     * Listeners of this event are passen a Arbory\Soap\Client\Event\WsdlResponseEvent. Any changes make to the
     ...
     *
     * The listener is passed a Arbory\Soap\Client\Event\CallEvent instance. It allows changing the method
     ...
     *
     * The listener is passed a Arbory\Soap\Client\Event\RequestEvent instance. The request and any
     ...
     * Arbory\Soap\Client\Event\ResponseEvent instance. The response can be modified before being processed
     ...
     * Arbory\Soap\Client\Event\FinishEvent instance. It allows changing the response for e.g. custom marshalling.
     *
     ...
     * Arbory\Soap\Client\Event\FaultEvent instance.
     *
